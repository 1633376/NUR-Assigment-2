...
% and adding it to the random number generator. This is done by first transforming the joined CDF of the two random Gaussian variables to polar coordinates. This transformation makes it possible to find the CDFs for the polar coordinates of the random Gaussian variables. 
...
\lstinputlisting[firstline=63,lastline=115]{./Code/assigment_1.py}
\end{quote}
